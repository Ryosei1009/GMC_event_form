...
const NewItemList2 = ({ token }) => {
  ...
  return (
    <>
      <Helmet
        title="申請済みアイテム - GMC 2周年イベント"
        meta={[
          { name: 'description', content: 'GMC 2周年イベント 申請済みアイテム' },
          { property: 'og:title', content: '申請済みアイテム - GMC 2周年イベント' },
        ]}
      />
